...
let goToTop = () => {
  document.body.scrollTo({ top: 25, behavior: "smooth" }) // For Safari
  document.documentElement.scrollTo({ top: 25, behavior: "smooth" }) // For Chrome, Firefox, IE and Opera
}
...
let myFunction = (e) => {
  ...
  // document.getElementById(newSection).scrollIntoView(true)
  document
    .getElementById(newSection)
  ...
  if (e.currentTarget.id.slice(-1) === 4) {
